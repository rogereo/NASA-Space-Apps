...
## Challenge Context
Built for the NASA Space Apps Challenge (2025) — A World Away: Hunting for Exoplanets with AI. The challenge invites teams to analyze open exoplanet datasets and prototype AI/ML methods that help identify exoplanets.
